...
class InferenceTRT:
    ...
    def load_engine(self, engine_path):
        ...
        # Allocate buffers
        self.h_input, self.d_input, self.h_output, self.d_output = self._allocate_buffers()
    ...
    def _do_inference(self):
        ...
        # Run inference.
        self.engine_ctx.execute_async_v2(bindings=[int(self.d_input), int(self.d_output)], stream_handle=stream.handle)
    ...
    def _allocate_buffers(self):
        ...
        # convert from tensorrt Dim to tuple
        output1_shape = tuple([output1_shape_dim[i] for i in range(len(output1_shape_dim))])
